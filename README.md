...
[![Version 0.1.8](https://img.shields.io/badge/version-0.1.8-4CC2FF?labelColor=0B0F14)](https://github.com/CyborgFingers/android-tv-ha-bridge/releases)
...
| Entity | What it does |
| --- | --- |
| `media_player.bedroom_tv` | State, `media_title`, `media_series_title`, episode, position / duration, poster (`entity_picture`), current app, up-next and ad attributes. Play / pause / stop / next / previous / seek, volume, turn on / off, `play_media`. |
